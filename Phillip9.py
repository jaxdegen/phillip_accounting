...
def open_planet_selector():
    planet_window = tk.Toplevel(root)
    planet_window.title("Select Planet")
    planet_window.geometry("350x500")
    ...
    selected_planet_var = tk.StringVar(value="Earth")
...
current_file = os.path.join("accounting.xlsx")
...
def calculate_2d_kinematics(data):
    """
...
"""
    ...
    try:
        ...
        # ---------------------------------
            ...
            results = calculate_2d_kinematics(data)
...
(Select Template Before Creating New Spreadsheet or Inputing Data)
    ...
    2D Kinematics Calculator:
        Calculates all physics components of a 2D Kinematics equation.
