...
current_file = os.path.join(DATA_FOLDER, "Welcome.xlsx")
...
def add_transaction(transaction=None, template=None, web=False):
    global current_file
...
"""
    ...
    if not web and entry is not None:
...
Questions, Feedback, or Problems?  |
                                   |
Email phillip.accounting@gmail.com |
___________________________________|
